...
export default function StudentProfilePage() {
  ...
  const save = useMutation({
    mutationFn: () => api('/students/me/profile', { method: 'PATCH', body: { phone: form.phone.trim() || null, cgpa: Number(form.cgpa) } }),
