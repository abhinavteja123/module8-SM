...
export default function AdminMarksPage() {
  ...
  const { data: research = [] } = useQuery({ queryKey: ['marks-research-applications'], queryFn: () => api('/research/applications') });
  const { data: selfInternships = [] } = useQuery({ queryKey: ['marks-self-internships'], queryFn: () => api('/self-internships') });
