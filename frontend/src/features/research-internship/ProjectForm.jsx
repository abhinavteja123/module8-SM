...
export default function ProjectForm() {
  ...
  return <div className="max-w-3xl space-y-6"><PageHeader eyebrow="Research studio" title="Manage research projects" description={`Create up to ${maxProjects} research projects and manage each one from its project card.`} /><UnlockRequestPanel />
